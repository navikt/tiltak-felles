...
class PersondataClientTest {
    ...
    public void hentNavn__tomt_navn_hvis_person_ikke_finens() {
        assertThat(persondataClient.hentNavn(PERSON_FINNES_IKKE).isPresent()).isFalse();
    }

    @Test
    public void hentNavn__navn_hvis_person_finnes() {
        assertThat(persondataClient.hentNavn(DONALD_DUCK).orElse(Navn.TOMT_NAVN)).isEqualTo(new Navn(
            "Donald",
            null,
            "Duck"
        ));
    ...
    public void erKode6__strengt_fortrolig() {
        assertThat(persondataClient.hentDiskresjonskode(STRENGT_FORTROLIG_PERSON)
    ...
    public void erKode6__strengt_fortrolig_utland() {
        assertThat(persondataClient.hentDiskresjonskode(STRENGT_FORTROLIG_UTLAND_PERSON)
            .orElse(Diskresjonskode.UGRADERT)
            .erKode6()).isTrue();
    }
    ...
    public void erKode6__fortrolig() {
        assertThat(persondataClient.hentDiskresjonskode(FORTROLIG_PERSON)
            .orElse(Diskresjonskode.UGRADERT)
            .erKode6()).isFalse();
    }
    ...
    public void erKode6__ugradert() {
        assertThat(persondataClient.hentDiskresjonskode(DONALD_DUCK)
            .orElse(Diskresjonskode.UGRADERT)
            .erKode6()).isFalse();
    }
    ...
    public void erKode6__ugradertTom() {
        assertThat(persondataClient.hentDiskresjonskode(UGRADERT_PERSON_TOM_RESPONSE)
            .orElse(Diskresjonskode.UGRADERT)
            .erKode6()).isFalse();
    }
    ...
    public void erKode6__uspesifisert_gradering() {
        assertThat(persondataClient.hentDiskresjonskode(USPESIFISERT_GRADERT_PERSON)
            .orElse(Diskresjonskode.UGRADERT)
            .erKode6()).isFalse();
    }
    ...
    public void erKode6_person_finnes_ikke_er_ok() {
        assertThat(persondataClient.hentDiskresjonskode(PERSON_FINNES_IKKE)
            .orElse(Diskresjonskode.UGRADERT)
            .erKode6()).isFalse();
    }
